                    ...
                    <div className="flex items-center gap-2">
                        {user ? (
                            <div className="flex items-center gap-3">
                                ...
                                <button onClick={async () => { await supabase.auth.signOut(); setVistaActual('home'); }} className="text-red-500 font-bold px-3 py-2 text-sm hover:bg-red-50 rounded-lg transition-colors flex items-center gap-1">
