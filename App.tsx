...
import { Search, ShoppingBag, Percent, Tag, Mail, Phone, LogIn, UserPlus, MessageCircle, X, Plus, Package, Settings, LogOut } from 'lucide-react';
...
const App: React.FC = () => {
    ...
    // VISTA: 'home' (Tienda) o 'panel' (Gestión)
        ...
        const iniciarBazar = async () => {
            ...
            try {
                ...
                if (session?.user) {
                    ...
                    setVistaActual('panel'); // Si entra logueado, va directo al panel
                }
    ...
    // Lógica de Filtros (Solo para vista Home)
        ...
        <div className="min-h-screen bg-white font-sans flex flex-col relative">
            ...
            <main className="flex-grow">
                {vistaActual === 'panel' && user ? (
                    // ================= VISTA PANEL DE CONTROL (PRIVADO) =================
                    <div className="container mx-auto px-4 py-8">
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                            ...
                            <button className="bg-green-600 text-white px-6 py-3 rounded-xl font-bold shadow-lg hover:bg-green-700 hover:scale-105 transition-all flex items-center gap-2">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                            <div className="bg-blue-50 p-6 rounded-2xl border border-blue-100">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p className="text-sm text-blue-600 font-bold">Mis Productos</p>
                                        <p className="text-2xl font-black text-gray-800">{productos.length}</p>
                                    </div>
                                </div>
                            </div>
                            <div className="bg-purple-50 p-6 rounded-2xl border border-purple-100">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p className="text-sm text-purple-600 font-bold">Ventas Totales</p>
                            ...
                            <div className="bg-orange-50 p-6 rounded-2xl border border-orange-100">
                                <div className="flex items-center gap-4">
                                    <div className="p-3 bg-orange-500 text-white rounded-lg"><Settings className="w-6 h-6"/></div>
                                    <div>
                                        <p className="text-sm text-orange-600 font-bold">Configuración</p>
                        ...
                        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                            <div className="p-6 border-b border-gray-100 flex justify-between items-center">
                                <h2 className="text-lg font-bold text-gray-800">Mis Publicaciones Recientes</h2>
                            </div>
                    ...
                    <div className="container mx-auto px-4 py-8">
                        <div className="hero-gradient text-center p-8 md:p-16 text-white rounded-3xl shadow-2xl mb-12">
                            ...
                            <p className="text-lg md:text-xl text-blue-100 mb-10 max-w-2xl mx-auto font-medium">Conectando Pymes y Microempresas contigo.</p>
                        ...
                        <div className="text-center mb-8"><h2 className="text-2xl font-bold text-gray-800 capitalize">{filtroActivo === 'todos' ? 'Novedades' : `Sección: ${filtroActivo}`}</h2></div>
